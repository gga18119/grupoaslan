		...
		<div class="header__wrapper">
			...
			<nav class="header__navigation">
				...
				<a href="#experience" class="js-smooth-scroll">
					<div class="header__navigation-element  header__navigation-element--experience">Vive la experiencia</div>
				</a>
				<a href="#features" class="js-smooth-scroll">
					<div class="header__navigation-element  header__navigation-element--features">Disfruat el momento</div>
				</a>
				...
				<a href="#contact" class="js-smooth-scroll">
					<div class="header__navigation-element  header__navigation-element--contact">Others...</div>
				</a>
			</nav>

			<a href="#start" class="header__title-wrapper  js-smooth-scroll">
				<div class="header__title-main">Grupo Aslan</div>
		...
		<div class="hero__content">
			<div class="hero__content-wrapper">
				<div class="hero__title-wrapper">
					...
					<div class="hero__title-small">This is Begin of your experience.</div>
				</div>
				...
				<div class="hero__description">
					It was created for my personal portfolio (but never used) and now I'm releasing it for free. Edit and use this template as you want, except selling or crediting it as your own. It would also be cool if you could share this. Did I forgot to mention that it also includes small easter egg? It does.
				</div>
			...
			<div class="realizations__wrapper">
				...
				<div class="showcase">
					<div class="showcase__thumbnails-wrapper">
						...
						<!-- normal -->
						<img data-project="p1" class="showcase__thumb  showcase__thumb--first  showcase__thumb--active" src="${resource(dir:'content', file: 'project01_thumb.jpg')}" >
